...
| :--- | :--- | :--- |
| **01** | [**01_preprocessing.md**](./01_preprocessing.md) | ✅ Complete — reference only. Suite2p / `2p reextract` procedures, session exclusions, sanity plots / optical offsets, offset audit evidence |
